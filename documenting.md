...
Any content generated by AI, whether it is sound, graphics, text, etc, is disallowed here.

This wiki is not to be plagued by slop and whilst it unfortunately is scraped by slop machines, it is not something that is intended.

The wiki is a *human* effort to help the people of Picotron.
